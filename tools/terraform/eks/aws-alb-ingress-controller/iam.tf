module "iam_assumable_role_admin" {
  ...
  role_policy_arns              = [element(concat(aws_iam_policy.ALBIngressControllerIAMPolicy[*].arn, list("")), 0)]
...
resource "aws_iam_policy" "ALBIngressControllerIAMPolicy" {
  ...
  policy =  data.aws_iam_policy_document.aws-alb-ingress-controller[0].json
}
