...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.181"
  val akkaKinesis             = "1.0.344"
  val cats                    = "2.9.0"
}
...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "23.2.5"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "23.2.5"
  }
  ...
  object fasterXmlJackson {
    ...
    val kotlin = "com.fasterxml.jackson.module"  % "jackson-module-kotlin" % "2.14.2"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.414"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.414"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.414"
      val s3         = "com.amazonaws" % "aws-java-sdk-s3"         % "1.12.329"
      val sqs        = "com.amazonaws" % "aws-java-sdk-sqs"        % "1.12.329"
    }
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.20.12"
    }
  }
