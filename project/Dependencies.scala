...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object jupiter {
    val jupiterApi              = "org.junit.jupiter" % "junit-jupiter-api"              % "5.9.0"
    val jupiter                 = "org.junit.jupiter" % "junit-jupiter"                  % "5.9.0"
    val jupiterMigrationSupport = "org.junit.jupiter" % "junit-jupiter-migrationsupport" % "5.9.0"
  }
