...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.149"
  val akkaKinesis             = "1.0.317"
  val cats                    = "2.9.0"
}
...
object Dependencies {
  ...
  object kodeinDI {
    val kodeinDIJvm = "org.kodein.di" % "kodein-di-jvm" % "7.18.0"
  }
  object arrowKt {
  ...
  object fasterXmlJackson {
    val scala  = "com.fasterxml.jackson.module" %% "jackson-module-scala"  % "2.13.5"
    val kotlin = "com.fasterxml.jackson.module"  % "jackson-module-kotlin" % "2.13.5"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      ...
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.389"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.389"
      val s3         = "com.amazonaws" % "aws-java-sdk-s3"         % "1.12.329"
      val sqs        = "com.amazonaws" % "aws-java-sdk-sqs"        % "1.12.329"
    }
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.19.21"
    }
  }
