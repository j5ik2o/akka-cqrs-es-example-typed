...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "23.5.2"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "23.5.2"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.462"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.462"
    ...
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.20.60"
    }
  }
