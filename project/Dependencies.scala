...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.176"
  val akkaKinesis             = "1.0.340"
  val cats                    = "2.9.0"
}
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.410"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.410"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.410"
