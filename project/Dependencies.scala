...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.114"
...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "22.12.4"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "22.12.4"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.367"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.367"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.367"
