...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.58"
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      ...
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.322"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.322"
