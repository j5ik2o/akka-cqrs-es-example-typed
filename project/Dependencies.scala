...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.553"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.553"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.553"
