...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "23.8.4"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "23.8.4"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.536"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.536"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.536"
