...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "24.1.0"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "24.1.0"
  }
  ...
  object kodeinDI {
    val kodeinDIJvm = "org.kodein.di" % "kodein-di-jvm" % "7.21.1"
  }
  object arrowKt {
  ...
  object fasterXmlJackson {
    val scala  = "com.fasterxml.jackson.module" %% "jackson-module-scala"  % "2.16.1"
    val kotlin = "com.fasterxml.jackson.module"  % "jackson-module-kotlin" % "2.16.1"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object jupiter {
    val jupiterApi              = "org.junit.jupiter" % "junit-jupiter-api"              % "5.10.1"
    val jupiter                 = "org.junit.jupiter" % "junit-jupiter"                  % "5.10.1"
    val jupiterMigrationSupport = "org.junit.jupiter" % "junit-jupiter-migrationsupport" % "5.10.1"
  }
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.635"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.635"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.635"
      val s3         = "com.amazonaws" % "aws-java-sdk-s3"         % "1.12.329"
      val sqs        = "com.amazonaws" % "aws-java-sdk-sqs"        % "1.12.329"
    }
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.23.1"
    }
  }
