...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "23.7.4"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "23.7.4"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      ...
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.520"
    ...
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.20.118"
    }
  }
