...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.159"
  val akkaKinesis             = "1.0.330"
  val cats                    = "2.9.0"
}
...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "23.2.0"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "23.2.0"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.400"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.399"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.399"
      val s3         = "com.amazonaws" % "aws-java-sdk-s3"         % "1.12.329"
      val sqs        = "com.amazonaws" % "aws-java-sdk-sqs"        % "1.12.329"
    }
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.19.30"
    }
  }
