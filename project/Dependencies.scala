...
object Version {
  ...
  val akkaPersistenceDynamoDB = "1.14.28"
}
...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "22.9.0"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "22.9.0"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts = "com.amazonaws" % "aws-java-sdk-sts" % "1.12.301"
    }
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.17.273"
    }
