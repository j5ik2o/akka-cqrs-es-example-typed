...
object Dependencies {
  ...
  object airframe {
    val di   = "org.wvlet.airframe" %% "airframe"      % "23.4.8"
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "23.4.8"
  }
...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.460"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.460"
    ...
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.20.56"
    }
  }
