...
//    val apmReporter   = "io.kamon" %% "kamon-apm-reporter"   % Version.kamon
  ...
  object awssdk {
    object v1 {
      val sts        = "com.amazonaws" % "aws-java-sdk-sts"        % "1.12.633"
      val dynamodb   = "com.amazonaws" % "aws-java-sdk-dynamodb"   % "1.12.633"
      val cloudwatch = "com.amazonaws" % "aws-java-sdk-cloudwatch" % "1.12.633"
      val s3         = "com.amazonaws" % "aws-java-sdk-s3"         % "1.12.329"
      val sqs        = "com.amazonaws" % "aws-java-sdk-sqs"        % "1.12.329"
    }
    object v2 {
      val sts = "software.amazon.awssdk" % "sts" % "2.22.13"
    }
  }
