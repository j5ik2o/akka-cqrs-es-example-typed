...
lazy val `test-base-scala` = (project in file("scala/test-base-scala"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.j5ik2o" %% "docker-controller-scala-localstack"     % "1.14.139",
      "com.github.j5ik2o" %% "docker-controller-scala-dynamodb-local" % "1.14.139",
      "com.github.j5ik2o" %% "docker-controller-scala-mysql"          % "1.14.139",
      "com.github.j5ik2o" %% "docker-controller-scala-flyway"         % "1.14.139",
      awssdk.v1.dynamodb,
