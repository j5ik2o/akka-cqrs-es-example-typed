...
lazy val `test-base-scala` = (project in file("scala/test-base-scala"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.j5ik2o" %% "docker-controller-scala-localstack"     % "1.15.17",
      "com.github.j5ik2o" %% "docker-controller-scala-dynamodb-local" % "1.15.17",
      "com.github.j5ik2o" %% "docker-controller-scala-mysql"          % "1.15.17",
      "com.github.j5ik2o" %% "docker-controller-scala-flyway"         % "1.15.17",
      awssdk.v1.dynamodb,
