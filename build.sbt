...
lazy val `test-base` = (project in file("test-base"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.j5ik2o" %% "docker-controller-scala-localstack"     % "1.14.48",
      "com.github.j5ik2o" %% "docker-controller-scala-dynamodb-local" % "1.14.48",
      "com.github.j5ik2o" %% "docker-controller-scala-mysql"          % "1.14.48",
      "com.github.j5ik2o" %% "docker-controller-scala-flyway"         % "1.14.48",
      awssdk.v1.dynamodb,
